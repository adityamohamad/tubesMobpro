...
public class SongActivity1 extends AppCompatActivity {
    String[] daftar, name;
    ListView ListView01;
    Menu menu;
    protected Cursor cursor;
    database dbcenter;
    public static SongActivity1 da; protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent inte = new Intent(SongActivity1.this, InputSinger.class);
                startActivity(inte);
            }
        });
        da = this;
    ...
    public void RefreshList(){
        ...
        ListView01.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView arg0, View arg1, int arg2, long arg3) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(SongActivity1.this);
                ...
                builder.setItems(dialogitem, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        switch (item) {
                            case 0:
                                Intent  i = new Intent(getApplicationContext(), ProfilSinger.class);
                                i.putExtra("nama", selection);
                                startActivity(i);
                                break;
                            case 1:// akan memanggil activity update data
                                Intent in = new Intent(getApplicationContext(), UpdateSinger.class);
